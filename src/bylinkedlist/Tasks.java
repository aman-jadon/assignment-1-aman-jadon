...
public class Tasks {
    ...
    public void deleteContact(LinkedList1 linkedList1) {
        if (!linkedList1.isEmpty()) {
            System.out.println("Here are all the contacts : Press the number against" + " to delete contact.");
            ...
            System.out.println("No contacts.You must add contacts before you could delete..");
        }
    }

    public void searchContact(LinkedList1 linkedList1) {
        System.out.println("You could search for a cotact from their first names:");
        String firstName = scanner.nextLine().trim();
